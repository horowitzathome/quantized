...
enum Which {
    #[value(name = "BartLargeCnn")]
    BartLargeCnn,
    #[value(name = "GPT3")]
    GPT3,
    #[value(name = "7b")]
    L7b,
    #[value(name = "7bGGUFG2K")]
    L7bGGUFG2K,
    #[value(name = "7bGGUFQ5KS")]
    L7bGGUFQ5KS,
    #[value(name = "13b")]
    L13b,
    #[value(name = "13bQ2")]
        ...
        let model_path = match &self.model {
            ...
            None => {
                let (repo, filename) = match self.which {
                    ...
                    Which::BartLargeCnn => ("facebook/bart-large-cnn", "pytorch_model.bin"),
                    Which::GPT3 => ("Vetehinen/gpt3-finnish-13B-GGML", "gpt3-finnish-13B.bloomz.ggml.q4_0.bin"),
                    Which::L7bGGUFG2K => ("TheBloke/CodeLlama-7B-GGUF", "codellama-7b.Q2_K.gguf"),
                    Which::L7bGGUFQ5KS => ("TheBloke/CodeLlama-7B-GGUF", "codellama-7b.Q5_K_S.gguf"),
                    Which::L13b => ("TheBloke/Llama-2-13B-GGML", "llama-2-13b.ggmlv3.q4_0.bin"),
                    Which::L13bQ2 => ("TheBloke/Llama-2-13B-GGML", "llama-2-13b.ggmlv3.q2_K.bin"),
